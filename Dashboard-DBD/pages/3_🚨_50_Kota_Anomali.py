...
try:
    ...
    with tab1:
        ...
        fig_map = px.choropleth_mapbox(
            ...
            geojson=geo_50kota, 
            locations='Kecamatan', 
            featureidkey="properties.district", # Pastikan key ini sesuai JSON-mu
            color=kolom_kasus,
            color_continuous_scale="Reds", 
            mapbox_style="carto-positron",
            center={"lat": -0.166, "lon": 100.65}, # Koordinat tengah 50 Kota
            zoom=9.5,
        ...
        if not df_anomali_year.empty:
            fig_map.add_scattermapbox(
                lat=df_anomali_year['lat'], # Pastikan ada kolom lat/lon di CSV-mu
